...
public class Cine extends UnicastRemoteObject implements ICine {
	...
	@Override
	public void anyadirEntrada(int id, String infoPelicula, String infoSesion, int precio, int cantidad, int precioTotal, String nombre) throws RemoteException {
	...
	peliculaDAO.deletePelicula(titulo);
