...
public class DatosPrueba {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Pelicula p2=  new Pelicula("Fantasy Island","TERROR",2020,"El enigmático Sr. Roarke ",110,"https://www.youtube.com/watch?v=R6gYEuYhudc&ab_channel=SonyPicturesEspa%C3%B1a","./src/main/resources/Imagenes/Fantasy Island.jpg","posters/Malasaña.jpg",2);
			pm.makePersistent(p2);
			
			
			
			
			Pelicula p3=  new Pelicula("Los Vengadores","ACCION",2019,"Película de marvel",220,"https://youtu.be/1XrrTJpA3yM","./src/main/resources/Imagenes/Los Vengadores.jpg","posters/Malasaña.jpg",2);
			...
			Pelicula p4=  new Pelicula("Annabelle vuelve a casa","TERROR",2020,"Película de la muñeca de terror",120,"https://www.youtube.com/watch?v=1VTnFrWGD-w&ab_channel=WarnerBros.PicturesEspa%C3%B1a","./src/main/resources/Imagenes/Annabelle vuelve a casa.jpg","posters/Malasaña.jpg",2);
